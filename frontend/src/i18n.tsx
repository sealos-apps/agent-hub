...
const zhCN = {
  ...
  'agent.reasonAgentPaused': '实例已暂停，请先启动后再进入。',
  'agent.reasonInstanceStartTimeout': '实例启动超时，请检查运行状态或稍后重试。',
...
const enUS: Record<TranslationKey, string> = {
  ...
  'agent.reasonAgentPaused': 'This instance is paused. Start it before entering.',
  'agent.reasonInstanceStartTimeout': 'The instance timed out while starting. Check its runtime status or try again later.',
