...
VITE_AGENTHUB_TERMINAL_ICON_URL="/brand/agenthub-terminal.svg"
```
...
# agenthub-terminal-app.yaml.tmpl
spec:
  icon: "{{ .agentHubUrl }}/brand/agenthub-terminal.svg" # Agent Hub Terminal hidden app
```
...
- Agent Hub Terminal hidden app 使用前端静态资源 `/brand/agenthub-terminal.svg`
- 不能直接传本地文件系统路径
