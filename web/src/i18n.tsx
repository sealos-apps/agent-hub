...
const zhCN = {
  ...
  'agent.deleteModalDesc': '将会联动删除实例 {displayName}{name} 及相关资源，操作不可撤销。',
  ...
  'console.loadFailedMock': '读取 Agent 控制台失败，已展示示例控制台。',
...
const enUS: Record<TranslationKey, string> = {
  ...
  'agent.deleteModalDesc': 'This will delete instance {displayName}{name} and related resources. This action cannot be undone.',
  ...
  'console.loadFailedMock': 'Failed to load Agent console. Showing a sample console.',
